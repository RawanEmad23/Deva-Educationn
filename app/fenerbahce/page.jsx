...
import cover from "../../Public/images/Fenerbahce-University-1.jpg";
import logo from "../../Public/images/Fenerbahce-University.jpg";
import altnnn from "../../Public/images/bakh1.png";
import altsss from "../../Public/images/bakh2.png";
import altn from "../../Public/images/bakh3.png";
import alt from "../../Public/images/bakh4.png";
import awrak from "../../Public/images/awark.jpg";
import coveren from "../../Public/images/franb_en.png";
import coverfr from "../../Public/images/franba_fr.png";
import coverfa from "../../Public/images/franb_fa.png";
import covertr from "../../Public/images/franbash_tr.png";
import coverru from "../../Public/images/fran_ru.png";
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 ml-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/9N_IS9-LXHI"
            allowFullScreen
          />
          ...
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("التصنيف العالمي")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">9187</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("التصنيف المحلي")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">176</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">54</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("عدد الطلاب")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">17,487 </b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">1780</b>
            </h1>
          </div>
        </div>
      </div>
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-sm:w-[75rem] max-sm:mr-6 max-lg:w-[75rem]">
        <div className="mr-5 bg-fuchsia-900 w-[30rem] mt-5 h-14 rounded-tr-lg rounded-bl-lg">
          <h1 className="font-bold text-3xl text-yellow-500 pr-2 pl-4 py-2">
            ...
            {t("معلومات عامة عن جامعة فنربهتشه")}
          </h1>
        </div>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("تأسست جامعة فنربهتشه في عام 2016.")}
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("جامعة فنربهتشه تقع في مدينة إسطنبول، تركيا، ولها حرم جامعي يقع في منطقة فنربهتشه. الحرم الجامعي يتميز بموقعه الجميل بالقرب من بحر مرمرة، ويشمل مرافق أكاديمية متقدمة، بالإضافة إلى مناطق للاسترخاء والتفاعل الاجتماعي للطلاب. من أبرز المرافق في الحرم الجامعي:")}
              <hr className="my-2" />
              <br className="" />
              
              {t("المكتبات: توفر مصادر أكاديمية واسعة.")}
              <br />
              <hr className="my-2" />
              
              {t("المرافق الترفيهية: مثل المقاهي والمطاعم التي توفر بيئة اجتماعية للطلاب.")}
              <br />
              <hr className="my-2" />
              
              {t("يمتاز الحرم الجامعي بتصميمه العصري والمتطور، ويعد مركزًا للأنشطة الأكاديمية والثقافية في نفس الوقت.")}
            </p>
          </div>
          <div className=" rounded-l">
            <Image src={altn} className="w-full" />
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("لغات التدريس في جامعة فنربهتشه؟")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("اللغات المعتمدة في جامعة فنربهتشه الإنكليزية أو التركية ويحدد ذلك بناءً على التخصص المطلوب واختيار الطالب.")}
              </p>
            ...
            >
              ...
              <h1 className="font-bold text-xl text-gray-800">
                ...
                {t("جامعة فنربهتشه في تركيا معترف بها من قبل العديد من الهيئات الأكاديمية الوطنية والدولية. إليك بعض المعلومات حول اعتمادات الجامعة:")}
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                
                {t("مجلس التعليم العالي التركي (YÖK) هو الهيئة الرسمية المسؤولة عن تنظيم وتنسيق التعليم العالي في تركيا")}
                <br />
                
                {t("إعتراف عالمي من قِبل دول الإتحاد الأوروبي.")}
                <br />
                
                {t("كما تسعى بعض برامجها للحصول على اعتماد من هيئات دولية متخصصة، مثل AACSB و AMBA، وذلك في مجالات مثل إدارة الأعمال.")}
                <br />
                
                {t("الجامعة تستقطب طلابًا دوليين، مما يعني أن بعض برامجها قد تكون معتمدة من قبل هيئات دولية متخصصة، وهي تسعى لتعزيز مستوى التعليم والبحث الأكاديمي بمواصفات دولية.")}
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("جامعة فنربهتشه توفر خيارات متنوعة للسكن الطلابي لتلبية احتياجات الطلاب المحليين والدوليين. السكن الطلابي مصمم لتوفير بيئة مريحة وآمنة تدعم حياة الطالب الأكاديمية والاجتماعية. فيما يلي معلومات عن السكن الطلابي في الجامعة:")}
                <br />
    
                {t("يمكن للطلاب اختيار السكن في شقق خاصة قريبة من الحرم الجامعي.")}
                
                <br />
                
                    
                {t("توفر الجامعة دعمًا للطلاب في العثور على خيارات سكن بديلة إذا لزم الأمر.")}
                <br />
                
                    
                {t("تختلف تكاليف السكن بناءً على نوع الغرفة والخدمات المقدمة. عادة ما يكون السكن الطلابي الجامعي خيارًا اقتصاديًا مقارنة بالسكن الخارجي في إسطنبول.")}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("الحياة الطلابية في جامعة فنربهتشه تُعدّ تجربة مميزة ومليئة بالأنشطة الأكاديمية والاجتماعية والثقافية، مما يجعلها بيئة مثالية لتطوير مهارات الطلاب وتعزيز تفاعلهم مع زملائهم. إليك لمحة عن الحياة الطلابية في الجامعة:")}
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  
                      
                  {t("ورش العمل والمحاضرات: تنظم الجامعة فعاليات أكاديمية مثل ورش العمل، الندوات، والمحاضرات التي يقدمها خبراء في مختلف المجالات.")}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  
                      
                  {t("الأندية الأكاديمية: يمكن للطلاب الانضمام إلى أندية متخصصة مثل نادي إدارة الأعمال، نادي الهندسة، ونادي الإعلام لتعزيز معرفتهم العملية.")}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                
                      
                  {t("الأندية الطلابية: تضم الجامعة مجموعة واسعة من الأندية التي تغطي اهتمامات مختلفة، مثل الموسيقى، الفن، الرياضة، البيئة، والتطوع.")}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  
                      
                  {t("الرحلات الطلابية: تنظيم رحلات داخل إسطنبول وخارجها لاستكشاف التراث الثقافي والطبيعي لتركيا.")}
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("مميزات الدراسة في جامعة فنربهتشه")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("تقدم برامج تعليمية معاصرة ومتوافقة مع المعايير الدولية. تتبع منهجيات تدريس حديثة تُركز على التطبيق العملي والبحث العلمي.")}
                <br />
                
                {t("الجامعة مرتبطة بنادي فنربهتشه الرياضي الشهير، مما يتيح للطلاب الاستفادة من مرافق النادي، خاصة في مجالات الرياضة والتربية البدنية.")}
                <br />
                
                {t("تضم الجامعة مرافق تعليمية متطورة، بما في ذلك مختبرات حديثة ومكتبات مجهزة بشكل كامل.")}
                <br />
                
                {t("توفر الجامعة خدمات استشارية وأكاديمية لمساعدة الطلاب على النجاح في دراستهم.")}
                <br />
                
                {t("توفر الجامعة برامج تدريبية بالتعاون مع الشركات المحلية والدولية، مما يساعد الطلاب على اكتساب خبرة عملية.")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("الأوراق المطلوبة للتقديم على جامعة فنربهتشه")}
                </h2>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("كليات وتخصصات جامعة فنربهتشه")}
                </h2>
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                           ...
                           {t("الأطراف الصناعية و تقويم العظام")} 
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
