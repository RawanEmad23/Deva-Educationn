      ...
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-sm:w-[75rem] max-sm:mr-6 max-lg:w-[75rem]">
        <div className="mr-5 bg-fuchsia-900 w-[30rem] mt-5 h-14 rounded-tr-lg rounded-bl-lg">
          <h1 className="font-bold text-3xl text-yellow-500 pr-2 pl-4 py-2">
            معلومات عامة عن جامعة فنربهتشه
          </h1>
        </div>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              تأسست جامعة فنربهتشه في عام 2016.
            </p>
            <h1 className="font-bold text-2xl text-fuchsia-950 mr-5">
              أحرمها الجامعية
            </h1>
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              جامعة فنربهتشه تقع في مدينة إسطنبول، تركيا، ولها حرم جامعي يقع في
              منطقة فنربهتشه. الحرم الجامعي يتميز بموقعه الجميل بالقرب من بحر
              مرمرة، ويشمل مرافق أكاديمية متقدمة، بالإضافة إلى مناطق للاسترخاء
              والتفاعل الاجتماعي للطلاب. من أبرز المرافق في الحرم الجامعي:
              <hr className="my-2" />
              <br className="" />
              المكتبات: توفر مصادر أكاديمية واسعة.
              <br />
              <hr className="my-2" />
              المرافق الترفيهية: مثل المقاهي والمطاعم التي توفر بيئة اجتماعية
              للطلاب.
              <br />
              <hr className="my-2" />
              يمتاز الحرم الجامعي بتصميمه العصري والمتطور، ويعد مركزًا للأنشطة
              الأكاديمية والثقافية في نفس الوقت.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  لغات التدريس في جامعة فنربهتشه؟
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة فنربهتشه الإنكليزية أو التركية ويحدد
            ...
            >
              ...
              <h1 className="font-bold text-xl text-gray-800">
                جامعة فنربهتشه في تركيا معترف بها من قبل العديد من الهيئات
                الأكاديمية الوطنية والدولية. إليك بعض المعلومات حول اعتمادات
                الجامعة:
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                مجلس التعليم العالي التركي (YÖK) هو الهيئة الرسمية المسؤولة عن
                تنظيم وتنسيق التعليم العالي في تركيا <br />
                إعتراف عالمي من قِبل دول الإتحاد الأوروبي.
                <br />
                كما تسعى بعض برامجها للحصول على اعتماد من هيئات دولية متخصصة،
                مثل AACSB و AMBA، وذلك في مجالات مثل إدارة الأعمال.
                <br />
                الجامعة تستقطب طلابًا دوليين، مما يعني أن بعض برامجها قد تكون
                معتمدة من قبل هيئات دولية متخصصة، وهي تسعى لتعزيز مستوى التعليم
                والبحث الأكاديمي بمواصفات دولية.
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                جامعة فنربهتشه توفر خيارات متنوعة للسكن الطلابي لتلبية احتياجات
                الطلاب المحليين والدوليين. السكن الطلابي مصمم لتوفير بيئة مريحة
                وآمنة تدعم حياة الطالب الأكاديمية والاجتماعية. فيما يلي معلومات
                عن السكن الطلابي في الجامعة:
                <br />
                يمكن للطلاب اختيار السكن في شقق خاصة قريبة من الحرم الجامعي.
                <br />
                توفر الجامعة دعمًا للطلاب في العثور على خيارات سكن بديلة إذا لزم
                الأمر.
                <br />
                تختلف تكاليف السكن بناءً على نوع الغرفة والخدمات المقدمة. عادة
                ما يكون السكن الطلابي الجامعي خيارًا اقتصاديًا مقارنة بالسكن
                الخارجي في إسطنبول.
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الحياة الطلابية في جامعة فنربهتشه تُعدّ تجربة مميزة ومليئة
                بالأنشطة الأكاديمية والاجتماعية والثقافية، مما يجعلها بيئة
                مثالية لتطوير مهارات الطلاب وتعزيز تفاعلهم مع زملائهم. إليك لمحة
                عن الحياة الطلابية في الجامعة:
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  ورش العمل والمحاضرات: تنظم الجامعة فعاليات أكاديمية مثل ورش
                  العمل، الندوات، والمحاضرات التي يقدمها خبراء في مختلف
                  المجالات.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  الأندية الأكاديمية: يمكن للطلاب الانضمام إلى أندية متخصصة مثل
                  نادي إدارة الأعمال، نادي الهندسة، ونادي الإعلام لتعزيز معرفتهم
                  العملية.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  الأندية الطلابية: تضم الجامعة مجموعة واسعة من الأندية التي
                  تغطي اهتمامات مختلفة، مثل الموسيقى، الفن، الرياضة، البيئة،
                  والتطوع.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  الرحلات الطلابية: تنظيم رحلات داخل إسطنبول وخارجها لاستكشاف
                  التراث الثقافي والطبيعي لتركيا.
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  مميزات الدراسة في جامعة فنربهتشه
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                تقدم برامج تعليمية معاصرة ومتوافقة مع المعايير الدولية. تتبع
                منهجيات تدريس حديثة تُركز على التطبيق العملي والبحث العلمي.
                <br />
                الجامعة مرتبطة بنادي فنربهتشه الرياضي الشهير، مما يتيح للطلاب
                الاستفادة من مرافق النادي، خاصة في مجالات الرياضة والتربية
                البدنية.
                <br />
                تضم الجامعة مرافق تعليمية متطورة، بما في ذلك مختبرات حديثة
                ومكتبات مجهزة بشكل كامل.
                <br />
                توفر الجامعة خدمات استشارية وأكاديمية لمساعدة الطلاب على النجاح
                في دراستهم.
                <br />
                توفر الجامعة برامج تدريبية بالتعاون مع الشركات المحلية والدولية،
                مما يساعد الطلاب على اكتساب خبرة عملية.
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة فنربهتشه
                </h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Orthopaedic Prosthesis And Orthesis -الأطراف
                            الصناعية و تقويم العظام
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          :
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            International Finance And Banking - التمويل الدولي
                            والمصارف
                          </p>
                        </div>
                        <hr className="my-2" />
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          :
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Exercise And Sport Sciences - التمارين وعلوم الرياضة
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
