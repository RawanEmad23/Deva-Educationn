...
import logo from "../../Public/images/Halic-University-1.jpg";
import altnnn from "../../Public/images/hal1.jpg";
import altsss from "../../Public/images/hal2.jpg";
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 ml-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/rbJXQ9l4z3c"
            allowFullScreen
          />
