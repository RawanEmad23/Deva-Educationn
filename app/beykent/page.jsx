...
import beken from "../../Public/images/bekyent_en.png";
import bekfr from "../../Public/images/bekent_fr.png";
import bekfa from "../../Public/images/bek_fa.jpg";
import bekru from "../../Public/images/bekent_ru.png";
import bektr from "../../Public/images/bekyent_tr.png";
...
const beykent = () => {
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("تقع جامعة بيكنت في مدينة اسطنبول في الجانب الأوروبي منها، وتمتلك أربعة حرم جامعية مجهزة على أعلى مستوى وتقع في المناطق المركزية في اسطنبول")}
            </p>
 ...
 <br />
              ...
              {t("وهو الحرم الرئيسي لجامعة بيكنت ويقع في ساريير باسطنبول، ويضم كليات الهندسة والعمارة، والفنون الجميلة، والاتصال، إضافة إلى ورش العمل، والمختبرات، والمطاعم، والمقاهي، والمكتبة")}
              <hr className="my-2" />
              <br className="" />
              
              {t("يقع حرم بيليك في بيوك تشكمجة وهو يضم العديد من كليات جامعة بيكنت، فهو يضم كليتي الطب البشري، وطب الأسنان، وكلية الآداب والعلوم، وكلية العلوم الصحية، وكلية العلوم التطبيقية، وبالإضافة إلى مدرسة اللغات الأجنبية.")}
              <br /> 
              {t("موقع الجامعة")}
              <br />
              <hr className="my-2" />
              ...
              {t("حرم هاديمكوي")}
              <br /> 
              {t("تم تأسيس حرم هاديمكوي في العام الدراسي 2017-2018 وهو يقع في مقاطعة إسنيورت باسطنبول ويضم كلية الاقتصاد والعلوم الإدارية،والمدرسة المهنية، كما يضم قاعة خاصة للقراءة وقاعة للمعارض.")}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("اللغات المعتمدة في جامعة بيكنت الإنكليزية أو التركية ويحدد ذلك بناءً على التخصص المطلوب واختيار الطالب.")}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("جامعة بيكنت (Beykent University) هي جامعة خاصة في تركيا معروفة بجودة برامجها الأكاديمية وتعدد تخصصاتها. فيما يلي ملخص حول الاعتمادات والاعترافات الخاصة بالجامعة:")}
                <hr className="my-2" />
                <br />
                
                {t("جميع برامج جامعة بيكنت معتمدة من قبل مجلس التعليم العالي في تركيا.")}
                <br />
                
                {t("جامعة بيكنت تسعى باستمرار لتطوير برامجها الأكاديمية بما يتماشى مع المعايير الدولية.")}
                <br />
                
                {t("العديد من الدول تعترف بشهادات الجامعة، خاصة تلك التي لديها اتفاقيات ثنائية تعليمية مع تركيا.")}
                <br />
                
                {t("يمكن للطلاب الدوليين التحقق من الاعتراف بشهادة الجامعة في بلدانهم من خلال السفارات أو الجهات التعليمية الرسمية.")}
                <br />
                
                {t("الجامعة عضو نشط في برنامج إيراسموس+ (Erasmus+)، الذي يسمح للطلاب بالدراسة في العديد من الجامعات الأوروبية لفصل دراسي أو عام كامل.")}
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("توفر جامعة بيكنت سكن طلابي حديث منفصل للطلاب والطالبات، يقع فيمنطقة أيازاغا ويبعد فقط عشر دقائق من الحرم الجامعي أيازاغا – مسلك. يوفر السكن للطلابي بيئة مريحة وآمنة للطلاب ويقدم لهم كافة الخدمات والمرافق والمساحات المشتركة حيث يستطيع الطلاب المذاكرة أو اللعب والاستمتاع باوقات فراغهم.")}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("تقدم جامعة بيكنت خدماتها التعليمية بأحدث الطرق والنظم التعليمية داخل بيئة تعليمية فعالة تساعد الطلاب على البحث والابتكار تحت إشراف طاقم أكاديمي قوي من الأساتذة والخبراء")}
                <br />
                
                {t("تمتلك الجامعة أكثر من 10 مراكز أبحاث ومركز للتعلم المستمر والتوظيف ومركز التعليم عن بعد")}
                <br />
                
                {t("تضم جامعة بيكنت أكثر من 100 مجتمع طلابي تغطي مختلف المجالات ليستطيع الطلابة ممارسة هواياتهم المفضلة والمشاركة في الأنشطة الطلابية المختلفة")}
                <br />
                {t("مساعدة الطلاب على إنشاء سيرتهم الذاتية خلال فترة الدراسة ومنح الطلاب فرصة للعمل كطلاب مساعدين في الخدمات الإدارية")}
                <br />
                
                {t("خدمات التدريب المهني من خلال التعاون مع الرواد في مختلف قطاعات الصناعة والأعمال لتوفير فرص التدريب للطلاب خلال فترة الدراسة بالإضافة إلى تمكين الطلاب من إنشاء المشاريع المبتكرة")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("مميزات الدراسة في جامعة بيكنت")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("4 أحرم جامعية متمركزة في أشهر المناطق الاستراتيجية على الجانبي الآسيوي والأوروبي لمدينة إسطنبول.")}
                <br />
                <hr className="py-2" />
                
                {t("تحتوي الجامعة على مكتبة ضخمة تضم مراجع وكتب وأوراق بحثية.")}
                <br />
                <hr className="py-2" />
                ...
                {t("يعتبر القسم الأوروبي من مدينة اسطنبول والتي تقع فيها الجامعة مركز لأغلب المناطق السياحية وباعتبار الجامعة تمتلك العديد من الأحرام الجامعية فلكل حرم جامعي له ميزته في الحرم الجامعي الموجود في مسلك وتقسيم يعتبر الأفضل من ناحية الترفيه")}
                <br />
                <hr className="py-2" />
                
                {t("تقدم الجامعة فرص متساوية للطلاب ذوي الاحتياجات الخاصة في التحصيل العلمي والمشاركة في الأنشطة الاجتماعية والثقافية.")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("الأوراق المطلوبة للتقديم على جامعة بيكنت")}
                </h2>
                   ...
                   {t("العلاج الطبيعي وإعادة التأهيل")} 
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            <b className="text-red-600">  {t("التركية")}
                            </b>
                          </p>
                        </div>
                        <hr className="my-2" />
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                             ...
                             {t("الترجمة الروسية والترجمة الفورية")}
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
