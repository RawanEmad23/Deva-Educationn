...
import coveren from "../../Public/images/isik_en.png";
import coverfr from "../../Public/images/isik_fr.png";
// import coverfa from "../../Public/images/isik_fa.png";
import covertr from "../../Public/images/isik_tr.png";
import coverru from "../../Public/images/isik_ru.png";
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("تأسست جامعة إيشك (İşık University) في عام 1996 في مدينة إسطنبول، تركيا. تم إنشاؤها كمؤسسة تعليمية خاصة تحت إشراف مؤسسة العلوم والتكنولوجيا التركية (Işık Foundation). بدأت الجامعة رحلتها بتقديم برامج تعليمية تهدف إلى تزويد الطلاب بالمعرفة والمهارات اللازمة في مختلف المجالات الأكاديمية.")}
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("جامعة إيشك تمتلك حرمين جامعيين رئيسيين في إسطنبول:")}
              <hr className="my-2" />
              <br className="" />
              
              {t("الحرم الجامعي الرئيسي (Işık University Main Campus): يقع في منطقة Şile، وهي منطقة جميلة خارج وسط المدينة، حيث توفر بيئة هادئة تركز على التعليم والبحث.")}
              <br />
              <hr className="my-2" />
              <br />
              
              {t("حرم Çekmeköy: يقع في منطقة Çekmeköy، وهو حرم جامعي حديث يقدم خدمات أكاديمية ومرافق ملائمة لدراسة مختلف البرامج الأكاديمية.")}
              <br />
              <hr className="my-2" />
            
              {t("كلا الحرمين يوفران بيئة تعليمية حديثة ومتطورة للطلاب، مع التركيز على توفير الراحة والفرص التعليمية المتكاملة.")}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("اللغات المعتمدة في جامعة إيشيك الإنكليزية أو التركية ويحدد ذلك بناءً على  التخصص المطلوب واختيار الطالب.")}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("اعتماد البرمجيات الهندسية والتقنية: البرامج الهندسية في جامعة إيشك، مثل برامج الهندسة الكهربائية والهندسة الصناعية، قد حصلت على اعتماد من هيئات أكاديمية متخصصة، مما يجعل شهادات هذه البرامج معترفًا بها في مجال العمل الدولي.")}
                <br />
                
                {t("الاعتماد الأكاديمي الدولي: بعض برامج الجامعة حصلت على اعتماد من هيئات دولية. هذه الاعتمادات تتيح للطلاب الحصول على تعليم معترف به دوليًا، مما يسهل عليهم العمل أو متابعة دراساتهم العليا في الخارج.")}
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("جامعة إيشك توفر خيارات سكنية متنوعة للطلاب داخل الحرم الجامعي وفي المناطق المحيطة به. السكن الطلابي في الجامعة يهدف إلى توفير بيئة مريحة وآمنة لدعم تجربة الطالب الأكاديمية والاجتماعية. إليك بعض المعلومات حول السكن الطلابي في جامعة إيشك: السكن داخل الحرم الجامعي: يوجد في الحرم الجامعي الرئيسي في Şile وبعض المرافق السكنية للطلاب، حيث يمكن للطلاب الإقامة في غرف فردية أو مشتركة. تم تجهيز السكن الطلابي بمرافق أساسية مثل الإنترنت، وتكييف الهواء، ومرافق للغسيل، ومناطق ترفيهية وداعمة للدراسة.")}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("الحياة الطلابية في جامعة إيشك تتميز بتنوع الأنشطة والفرص التي تهدف إلى تطوير مهارات الطلاب خارج نطاق الفصول الدراسية. توفر الجامعة بيئة داعمة وملهمة للطلاب للانخراط في الأنشطة الاجتماعية، الثقافية، الرياضية، والبحثية، مما يعزز من تجربتهم الجامعية. إليك بعض الجوانب المهمة للحياة الطلابية في جامعة إيشك:")}
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  
                  {t("النوادي الطلابية: تقدم الجامعة مجموعة واسعة من الأندية الطلابية التي تغطي مجالات متنوعة مثل الفنون، الرياضة، التكنولوجيا، الأدب، والمسؤولية الاجتماعية. يمكن للطلاب الانضمام إلى هذه الأندية للمشاركة في الأنشطة المنظمة مثل الندوات، العروض الفنية، والمعارض")}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                ...
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  ...
                  {t("الفعاليات الثقافية: تحرص الجامعة على تنظيم فعاليات ثقافية مثل حفلات الموسيقى، ورش العمل الفنية، والمهرجانات السنوية التي تجمع الطلاب من مختلف الخلفيات الثقافية.")}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  
                  {t("جامعة إيشك توفر منشآت رياضية حديثة، بما في ذلك ملاعب كرة القدم، كرة السلة، وصالات لياقة بدنية، ما يتيح للطلاب المشاركة في الأنشطة الرياضية والتمارين البدنية.")}
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("مميزات الدراسة في جامعة إيشيك")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("دراسة في جامعة إيشك تتمتع بعدد من المميزات التي تجعلها خيارًا مفضلًا للطلاب المحليين والدوليين على حد سواء. إليك بعض أهم مميزات الدراسة في جامعة إيشك:")}
                <br />
                
                {t("تقدم جامعة إيشك برامج أكاديمية متطورة في مختلف التخصصات، وتستخدم طرق تدريس حديثة تركز على تطوير المهارات العملية والنظرية للطلاب.")}
                <br />
                
                {t("يُدرس الطلاب في بيئة أكاديمية تدعم البحث والابتكار، حيث توفر الجامعة تقنيات وموارد متطورة للمساعدة في التجارب التعليمية.")}
                <br />
                
                {t("تقدم جامعة إيشك مجموعة واسعة من البرامج الأكاديمية في مجالات مثل الهندسة، العلوم الاجتماعية، الفنون، الأعمال، التصميم، والعلوم الطبيعية.")}
                <br />
                
                {t("تشجع الجامعة طلابها على الانخراط في الأبحاث الأكاديمية والتجريبية، مما يتيح لهم فرصة المشاركة في مشاريع بحثية مع أساتذة وخبراء في مجالاتهم.")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("الأوراق المطلوبة للتقديم على جامعة إيشيك")}
                </h2>
