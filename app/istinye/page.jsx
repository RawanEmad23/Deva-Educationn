...
import cover from "../../Public/images/Istinye-University.jpg";
import logo from "../../Public/images/Istinye-University-1.jpg";
import altnnn from "../../Public/images/ist1.jpg";
import altsss from "../../Public/images/ist2.jpg";
import altn from "../../Public/images/ist3.jpg";
import alt from "../../Public/images/ist4.jpg";
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 ml-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/PPnS6ZzPNos"
            allowFullScreen
          />
          ...
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              التصنيف العالمي:{" "}
              <b className="text-xl text-gray-500 max-sm:text-3xl">6640</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
          ...
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">171</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              عدد الطلاب :{" "}
              <b className="text-xl text-gray-500 max-sm:text-3xl">16,318</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              عدد الطلاب الاجانب:{" "}
              <b className="text-xl text-gray-500 max-sm:text-3xl">2000</b>
            </h1>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              جامعة إستيني (جامعة استينيه) هي جامعة خاصة تقع في مدينة إسطنبول،
              تركيا. تم تأسيسها في عام 2012. تهدف الجامعة إلى تقديم برامج
              تعليمية ذات جودة عالية، وهي تقدم مجموعة من التخصصات في مجالات
              مختلفة.
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              جامعة إستينيه في إسطنبول تتمتع بحرم جامعي حديث ومتطور يوفر بيئة
              تعليمية متميزة للطلاب. الحرم الجامعي يحتوي على مرافق متنوعة تشمل:
              <hr className="my-2" />
              <br className="" />
              المرافق الأكاديمية: توفر الجامعة مجموعة من القاعات الدراسية
              المجهزة بأحدث التقنيات، بالإضافة إلى مختبرات علمية ومراكز بحثية في
              مختلف التخصصات.
              <br />
              <hr className="my-2" />
              <br />
              لمكتبات: تحتوي الجامعة على مكتبات ضخمة تضم مصادر أكاديمية وكتب
              ومجلات في مختلف المجالات.
              <br />
              <hr className="my-2" />
              المرافق الاجتماعية والترفيهية: هناك مناطق مخصصة للراحة والاسترخاء،
              بالإضافة إلى مقاهي ومطاعم يمكن للطلاب استخدامها.
              <hr className="my-2" />
              لمرافق الرياضية: تشمل صالات رياضية مجهزة، ملاعب خارجية، ومرافق
              أخرى تشجع على النشاط البدني
              <br />
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة إستينيا الإنكليزية أو التركية ويحدد ذلك
            ...
            >
              ...
              <h1 className="font-bold text-xl text-gray-800">
                الجامعة تقدم العديد من البرامج المعتمدة في مجالات مختلفة وتعمل
                على تطوير برامج تعليمية تهدف إلى تزويد الطلاب بالمعرفة والمهارات
                اللازمة للمنافسة في السوق العالمي.
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                <br />
                الاعتماد المحلي، تسعى الجامعة إلى تحقيق الاعتمادات الدولية في
                مجالات متنوعة، بما في ذلك المجالات الطبية والهندسية، مما يعزز من
                مكانتها الأكاديمية في تركيا وعلى مستوى العالم
                <br />
                تلتزم جامعة إستينيه بالمعايير الدولية في التعليم، مما يجعلها
                وجهة مفضلة للطلاب الدوليين الراغبين في دراسة البرامج التي تتمتع
                بجودة أكاديمية عالية.
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                جامعة إستينيه توفر خيارات سكن طلابي مريحة وآمنة داخل الحرم
                الجامعي أو بالقرب منه. تتنوع خيارات السكن بما يتناسب مع احتياجات
                الطلاب المختلفة، وتتميز بكونها مجهزة بكافة الخدمات التي تساهم في
                توفير بيئة تعليمية وداعمة. إليك بعض المميزات التي عادة ما يتوفر
                في سكن الطلاب في الجامعة:
                <br />
                غرف مجهزة بأساسيات الحياة اليومية مثل الأسرة، المكاتب، وخزائن
                الملابس. \خدمات الإنترنت اللاسلكي في جميع أنحاء السكن. \ مناطق
                اجتماعية لراحة الطلاب وتفاعلهم مع بعضهم البعض. \تقدم الجامعة
                خدمات دعم للطلاب الساكنين مثل التوجيه الأكاديمي والشخصي، لضمان
                التكيف مع الحياة الجامعية.
              </p>
              <Image src={alt} className="mt-5 mx-auto w-[40rem]" />
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
              open
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                لحياة الطلابية في جامعة إستينيه تتميز بتنوع الأنشطة والفرص التي
                توفر بيئة تعليمية واجتماعية متكاملة. الجامعة تسعى إلى تطوير
                تجربة طلابية شاملة تركز على الجوانب الأكاديمية والاجتماعية
                والثقافية والرياضية. إليك بعض الجوانب الرئيسية التي تميز الحياة
                الطلابية في جامعة إستينيه:
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  النوادي الطلابية: تحتوي الجامعة على العديد من النوادي الطلابية
                  التي تغطي مجالات متنوعة مثل الرياضة، الفن، الثقافة،
                  التكنولوجيا، والأنشطة الاجتماعية. هذه النوادي توفر فرصًا
                  للتفاعل الاجتماعي وتطوير المهارات خارج الفصول الدراسية.
                  الفعاليات الثقافية والفنية: تقيم الجامعة{" "}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  الفعاليات الثقافية والفنية: تقيم الجامعة العديد من الفعاليات
                  مثل الحفلات الموسيقية، العروض المسرحية، والمعارض الفنية، التي
                  تشجع الطلاب على التعبير عن أنفسهم بشكل إبداعي.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  توفر الجامعة العديد من الفرص لممارسة الرياضة، من خلال الصالات
                  الرياضية المجهزة وملاعب كرة القدم وكرة السلة. بالإضافة إلى
                  ذلك، توجد فعاليات رياضية ومنافسات بين الطلاب لتعزيز روح الفريق
                  والتنافس الصحي.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  نظراً لأن الجامعة تستقبل طلابًا دوليين من مختلف أنحاء العالم،
                  فإن الحياة الطلابية في جامعة إستينيه توفر فرصًا رائعة للتعرف
                  على ثقافات وتجارب مختلفة. هذا التفاعل يعزز من فهم الطلاب
                  للثقافات المتنوعة ويشجع على التعايش والتبادل الثقافي.
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  مميزات الدراسة في جامعة إستينيا
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الدراسة في جامعة إستينيه تتميز بعدة جوانب تجعلها واحدة من
                الجامعات المميزة في تركيا، سواء من حيث الجودة الأكاديمية أو
                الفرص المتاحة للطلاب. إليك بعض المميزات التي تجعل الدراسة في
                جامعة إستينيه تجربة مميزة:
                <br />
                برامج أكاديمية متنوعة: تقدم الجامعة مجموعة واسعة من البرامج
                الأكاديمية في مجالات مختلفة مثل الهندسة، الطب، إدارة الأعمال،
                الفنون، والعلوم الاجتماعية، مما يتيح للطلاب اختيار التخصصات التي
                تتناسب مع اهتماماتهم <br />
                ...
                <br />
                التعليم بأساليب حديثة: تعتمد جامعة إستينيه على أساليب تعليمية
                مبتكرة، تشمل استخدام التقنيات الحديثة في الفصول الدراسية
                والمختبرات العلمية، مما يوفر بيئة تعليمية تفاعلية
                <br />
                لحرم الجامعي مجهز بمرافق تعليمية حديثة، مثل المختبرات العلمية
                المتطورة، والمكتبات الرقمية، والصالات الرياضية، والمرافق
                الاجتماعية، مما يعزز من تجربة التعلم والتفاعل بين الطلاب.
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة إستينيا
                </h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Food Technology -تكنلوجيا التغذية
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Automotive Technologies -تكنلوجيا السيارات
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Electro Neurophysiology -الفيزيولوجيا الكهربائية
                            العصبية
                          </p>
                        </div>
                        <hr className="my-2" />
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            E-Trade And Marketing-التجارة و التسويق الإلكتروني
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Molecular Biology and Genetics-البيولوجيا الجزيئية
                            وعلم الوراثة{" "}
                          </p>
                        </div>
                        <hr className="my-2" />
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          :
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Social Service - الخدمة الاجتماعية
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            ا <b className="text-red-600">التركية</b>
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 text-gray-800 font-semibold text-lg">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          :
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Public Administration And Political Science-الإدارة
                            العامة و العلوم السياسية
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Surgical Disease Nursing-التمريض (الأمراض الجراحية)
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Obstetrics And Gynaecologic Nursing-التمريض (صحة
                            المرأة و التوليد)
                          </p>
                        </div>
                        <hr className="my-2" />
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Communication Sciences-علوم الاتصالات
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Stem Cell And Tissue Engineering-الخلايا الجذعية و
                            هندسة الأنسجة
                          </p>
                        </div>
                        <hr className="my-2" />
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Medical Biology And Genetics-البيولوجيا الجزيئية و
                            علم الوراثة
                          </p>
                        </div>
                        <hr className="my-2" />
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Histology And Embryology-علم الأنسجة و الأجنة
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Molecular Oncology-علم الأورام الجزيئي
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
