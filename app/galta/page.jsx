        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              تأسست جامعة إسطنبول جالاتا (Istanbul Galata University) في عام
              2020، وهي جامعة خاصة حديثة تقع في مدينة إسطنبول بتركيا. على الرغم
              من حداثة تأسيسها، إلا أنها أصبحت واحدة من الجامعات التي تركز على
              تقديم تعليم عالي الجودة في مجالات متنوعة، مع التركيز بشكل خاص على
              العلوم الصحية والتقنية.
            </p>
            <h1 className="font-bold text-2xl text-fuchsia-950 mr-5">
              أحرمها الجامعية
            </h1>
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              جامعة إسطنبول جالاتا تضم حرمين جامعيين رئيسيين، وكلاهما يقع في
              مدينة إسطنبول، مما يتيح للطلاب الاستفادة من موقعها الحيوي في قلب
              المدينة. تتميز أحرامها الجامعية بما يلي:
              <hr className="my-2" />
              <br className="" />
              تقع في مناطق قريبة من المواصلات العامة والمرافق الحيوية، مما يسهل
              على الطلاب التنقل داخل إسطنبول.
              <br />
              <hr className="my-2" />
              <br />
              توفر مساحات للأنشطة الطلابية، مثل الصالات الرياضية والمرافق
              الاجتماعية، لدعم الحياة الطلابية.
              <br />
              <hr className="my-2" />
              تحتوي الأحرام الجامعية على مختبرات علمية متقدمة، قاعات دراسية
              مجهزة بتقنيات تعليمية حديثة، ومكتبة شاملة.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة جالاتا الإنكليزية أو التركية ويحدد ذلك
            ...
            >
              ...
              <h1 className="font-bold text-xl text-gray-800">
                حازت جامعة جالاتا في اسطنبول على إعتمادات عالمية عديدة منها:
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                <br />
                برامج الجامعة معترف بها في العديد من الدول، مما يجعلها خيارًا
                جيدًا للطلاب الأجانب الذين يرغبون في مواصلة دراستهم أو العمل
                خارج تركيا.
                <br />
                ما أن الجامعة تركز بشكل كبير على الطب وطب الأسنان والعلوم
                الصحية، فهي تسعى للحصول على اعتمادات متخصصة لهذه البرامج لضمان
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                جامعة إسطنبول جالاتا توفر خيارات سكن طلابي مريحة للطلاب، سواء
                كانوا من الطلاب المحليين أو الدوليين. بعض التفاصيل حول السكن
                الطلابي في الجامعة تشمل:
                <br />
                الجامعة توفر بعض المرافق السكنية داخل الحرم الجامعي أو بالقرب
                منه لتوفير الراحة وسهولة الوصول إلى المحاضرات والمرافق الأخرى.
                <br />
                يمكن للطلاب الاختيار بين غرف فردية أو مشتركة، مع توفير الخدمات
                الأساسية مثل الإنترنت، الأمن، والمرافق المشتركة.
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الحياة الطلابية في جامعة إسطنبول جالاتا تُعد من التجارب الغنية
                والمتنوعة التي تهدف إلى تقديم بيئة تعليمية ممتعة ومتكاملة. تشمل
                جوانب الحياة الطلابية في الجامعة ما يلي:
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  تنظم الجامعة العديد من الفعاليات الثقافية والفنية، مثل العروض
                  المسرحية، والمهرجانات، والمعارض الفنية.{" "}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  توفر الجامعة مرافق رياضية حديثة تشمل صالات رياضية وملاعب
                  متعددة الاستخدامات. كما تُشجع على ممارسة الرياضة من خلال
                  مسابقات وأنشطة رياضية دورية
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  تعقد الجامعة مؤتمرات، ورش عمل، وندوات أكاديمية لتعزيز التجربة
                  التعليمية للطلاب. هذه الفعاليات تساعد الطلاب على توسيع معرفتهم
                  والتفاعل مع الخبراء في مجالاتهم.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  تولي الجامعة اهتمامًا كبيرًا بالطلاب الدوليين وتوفر لهم برامج
                  دعم خاصة، مثل المساعدة في التكيف مع الحياة في تركيا،
                  والإرشادات الأكاديمية، والدورات اللغوية لتقوية مهارات اللغة
                  التركية أو الإنجليزية
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  مميزات الدراسة في جامعة جالاتا
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الدراسة في جامعة إسطنبول جالاتا تتميز بعدد من الجوانب التي
                تجعلها وجهة جذابة للطلاب المحليين والدوليين. من أبرز مميزات
                الدراسة في هذه الجامعة:
                <br />
                توفر الجامعة مرافق تعليمية وتقنية متطورة مثل المختبرات المتخصصة،
                المكتبات الرقمية، قاعات المحاضرات الذكية، والمرافق الرياضية، مما
                يعزز من تجربة التعلم
                <br />
                تشجع جامعة إسطنبول جالاتا طلابها على الانخراط في مشاريع بحثية
                متقدمة، مما يساعدهم على تطوير مهارات البحث والتحليل.
                <br />
                لجامعة لها شراكات مع العديد من الجامعات والمؤسسات الأكاديمية
                الدولية، مما يوفر للطلاب الفرصة للدراسة في الخارج أو المشاركة في
                برامج تبادل أكاديمي.
                <br />
                تقدم الجامعة خدمات دعم متكاملة للطلاب الدوليين، مثل المساعدة في
                التكيف مع البيئة التركية، الدورات اللغوية، والإرشاد الأكاديمي،
                مما يسهل عليهم العيش والدراسة في تركيا
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة جالاتا
                </h2>
              ...
              <div className="flex flex-wrap gap-12 justify-center">
                <div className="absolute text-fuchsia-700 text-4xl font-bold mt-36 max-lg:-ml-[20rem] max-lg:text-2xl">
                  <p className="mr-6 max-lg:mr-20">بكالوريوس</p>
