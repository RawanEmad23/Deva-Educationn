"use client"
import altnnn from "../../Public/images/bur1.jpg";
import altsss from "../../Public/images/bur2.webp";
import altn from "../../Public/images/bur3.webp";
import alt from "../../Public/images/bur4.webp";
import Image from "next/image";
import cover from "../../Public/images/Biruni-University-1.jpg";
import logo from "../../Public/images/Biruni-University.jpg";
import awrak from "../../Public/images/awark.jpg";
import { useTranslation } from "react-i18next";
import coverfr from "../../Public/images/burini_fr.png";
import coverfa from "../../Public/images/burini_fa.png";
import covertr from "../../Public/images/burini_tr.png";
import coverru from "../../Public/images/burini_ru.png";
import coveren from "../../Public/images/burini_en.png";
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 ml-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/z2RCMBzmagM"
            allowFullScreen
          />
          ...
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("التصنيف العالمي")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">2819</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("التصنيف المحلي")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">90</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">53</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("عدد الطلاب")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">13,189</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">1,800</b>
            </h1>
          </div>
        </div>
      </div>
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-sm:w-[75rem] max-sm:mr-6 max-lg:w-[75rem]">
        <div className="mr-5 bg-fuchsia-900 w-[30rem] mt-5 h-14 rounded-tr-lg rounded-bl-lg">
          <h1 className="font-bold text-3xl text-yellow-500 pr-2 pl-4 py-2">
            ...
            {t("معلومات عامة عن جامعة بيروني")}
          </h1>
        </div>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("تقع جامعة بيروني بمدينة اسطنبول الطرف الأوروبي")}
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("يقع الحرم الجامعي الرئيسي والوحيد لجامعة بيروني في الجانب الأوروبي من مدينة اسطنبول في منطقة زيتون بورنو. يضم كافة كليات الجامعة ويمكن الوصول إليه بسهولة باستخدام وسائل النقل العام")}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("لغات التدريس في جامعة بيروني ؟")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("اللغات المعتمدة في جامعة بيروني الإنكليزية أو التركية ويحدد ذلك بناءً على التخصص المطلوب واختيار الطالب.")}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("جامعة البيروني هي جامعة خاصة في تركيا، معترف بها من قبل مجلس التعليم العالي التركي (YÖK)، مما يضمن أن شهاداتها معترف بها محليًا ودوليًا. تحظى الجامعة باعترافات واعتمادات من عدة دول ومؤسسات دولية، بما في ذلك الاتحاد الأوروبي والعديد من الدول العربية مثل مصر، اليمن، لبنان، وليبيا. كما أنها عضو في منظمات تعليمية دولية مثل NAFSA (جمعية التعليم الدولي) وEAIE (الرابطة الأوروبية للتعليم الدولي)، مما يعزز من فرص التعاون الأكاديمي والتبادل الدولي.")}
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("تهدف جامعة بيروني أن تحافظ على مكانتها باعتبارها جامعة خاصة مفضلة للطلاب عالميًا ومحليًا، وذلك بسبب الجودة التعليمية المقدمة في كافة برامجها التعليمية، واشتمالها على كادر أكاديمي هم الأفضل في مجالاتهم.")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("الحياة العملية لطلاب جامعة بيروني.")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("تمتلك الجامعة مستشفيات من أكبر مستشفيات تركيا وهما مستشفى بيروني اسطنبول العام في كوتشوك شكمجه، ومستشفى طب الأسنان، مما يتيح لطلابها الحصول على فترة التدريب العملي قبل التخرج في أفضل وأهم الأماكن.")}
                <br />
               
                {t("توفر جامعة بيروني لطلابها الكثير من المشاريع العملية التي يشارك فيها الأساتذة والأكاديميين، والذي يُسمح للطلاب المشاركة فيها جنبًا إلى جنب مع مدرسيهم لتعزيز قوة الطالب البحثية وتهيئتهم لسوق العمل والأبحاث، وتأتي تحت غطاء برنامج يسمى بـ البرنامج الدراسي لتدريب العلماء الصغار.")}
                <br />
                
                {t("تمتلك الجامعة مركزًا للتوظيف، وذلك لمساعدة طلابها الخريجين من إيجاد فرص العمل بسهولة.")}
                <br />
                
                {t("توفر لطلابها العديد من الفرص الدولية بالتعاون مع المؤسسات الصحية الأخرى على مستوى العالم.")}
                <br />
                
                {t("تتميز بتطورها وتغيير تقنياتها بصفة دورية لمواكبة العصر والتقدم والتكنولوجيا.")}
              </p>
              <Image src={altn} className="mt-5 w-[50rem] mx-auto h-96" />
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
              open
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("مميزات الدراسة في جامعة بيروني")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("تمتلك الجامعة عدد 2 مستشفى تعليمي، هما مستشفى البيروني ومستشفى طب الأسنان، اللذان يقدمان للطلاب فرصة مميزة التدريب العملي تحت رعاية فريق من الخبراء المؤهلين.")}
                <br />
                <hr className="py-2" />
                
                {t("توفر الجامعة منحًا دراسية للطلاب الأجانب.")}
                <br />
                <hr className="py-2" />
                
                {t("توفر الجامعة التخصص المزدوج والتخصص المختصر، كما توفر حرية التنقل بين تخصصات جامعة بيروني المختلفة إذا لم تجده ملائمًا لشغفك.")}
                <br />
                <hr className="py-2" />
                
                {t("توفر برنامج التبادل الطلابي إيراسموس، الذي يمنح الطلاب فرصة قضاء فصل دراسي أو عام دراسي كامل في إدى الجامعات الأوروبية.")}
                <hr className="py-2" />
                
                {t("تتميز بشراكاتها مع مجموعة من المنظمات العالمية من خلال اتفاقيات التبادل الطلابي.")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("الأوراق المطلوبة للتقديم على جامعة بيروني")}
                </h2>
