        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              تقع جامعة بيروني بمدينة اسطنبول الطرف الأوروبي
            </p>
            <h1 className="font-bold text-2xl text-fuchsia-950 mr-5">
              الحرم الجامعي{" "}
            </h1>
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              يقع الحرم الجامعي الرئيسي والوحيد لجامعة بيروني في الجانب الأوروبي
              من مدينة اسطنبول في منطقة زيتون بورنو. يضم كافة كليات الجامعة
              ويمكن الوصول إليه بسهولة باستخدام وسائل النقل العام
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة بيروني الإنكليزية أو التركية ويحدد ذلك
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                جامعة البيروني هي جامعة خاصة في تركيا، معترف بها من قبل مجلس
                التعليم العالي التركي (YÖK)، مما يضمن أن شهاداتها معترف بها
                محليًا ودوليًا. تحظى الجامعة باعترافات واعتمادات من عدة دول
                ومؤسسات دولية، بما في ذلك الاتحاد الأوروبي والعديد من الدول
                العربية مثل مصر، اليمن، لبنان، وليبيا. كما أنها عضو في منظمات
                تعليمية دولية مثل NAFSA (جمعية التعليم الدولي) وEAIE (الرابطة
                الأوروبية للتعليم الدولي)، مما يعزز من فرص التعاون الأكاديمي
                والتبادل الدولي.
              </p>
            </details>
            <details
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                تهدف جامعة بيروني أن تحافظ على مكانتها باعتبارها جامعة خاصة
                مفضلة للطلاب عالميًا ومحليًا، وذلك بسبب الجودة التعليمية المقدمة
                في كافة برامجها التعليمية، واشتمالها على كادر أكاديمي هم الأفضل
                في مجالاتهم.
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الحياة العملية لطلاب جامعة بيروني.
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                تمتلك الجامعة مستشفيات من أكبر مستشفيات تركيا وهما مستشفى بيروني
                اسطنبول العام في كوتشوك شكمجه، ومستشفى طب الأسنان، مما يتيح
                لطلابها الحصول على فترة التدريب العملي قبل التخرج في أفضل وأهم
                الأماكن.
                <br />
                توفر جامعة بيروني لطلابها الكثير من المشاريع العملية التي يشارك
                فيها الأساتذة والأكاديميين، والذي يُسمح للطلاب المشاركة فيها
                جنبًا إلى جنب مع مدرسيهم لتعزيز قوة الطالب البحثية وتهيئتهم لسوق
                العمل والأبحاث، وتأتي تحت غطاء برنامج يسمى بـ "البرنامج الدراسي
                لتدريب العلماء الصغار".
                <br />
                تمتلك الجامعة مركزًا للتوظيف، وذلك لمساعدة طلابها الخريجين من
                إيجاد فرص العمل بسهولة.
                <br />
                توفر لطلابها العديد من الفرص الدولية بالتعاون مع المؤسسات الصحية
                الأخرى على مستوى العالم.
                <br />
                تتميز بتطورها وتغيير تقنياتها بصفة دورية لمواكبة العصر والتقدم
                والتكنولوجيا.
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  مميزات الدراسة في جامعة بيروني
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                تمتلك الجامعة عدد 2 مستشفى تعليمي، هما مستشفى البيروني ومستشفى
                طب الأسنان، اللذان يقدمان للطلاب فرصة مميزة التدريب العملي تحت
                رعاية فريق من الخبراء المؤهلين.
                <br />
                <hr className="py-2" />
                توفر الجامعة منحًا دراسية للطلاب الأجانب.
                <br />
                <hr className="py-2" />
                توفر الجامعة التخصص المزدوج والتخصص المختصر، كما توفر حرية
                التنقل بين تخصصات جامعة بيروني المختلفة إذا لم تجده ملائمًا
                لشغفك.
                <br />
                <hr className="py-2" />
                توفر برنامج التبادل الطلابي إيراسموس، الذي يمنح الطلاب فرصة قضاء
                فصل دراسي أو عام دراسي كامل في إدى الجامعات الأوروبية.
                <hr className="py-2" />
                تتميز بشراكاتها مع مجموعة من المنظمات العالمية من خلال اتفاقيات
                التبادل الطلابي.
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة بيروني
                </h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Nuclear Medicine Techniques -تقنيات الطب النووي
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Perfusion Techniques -تقنيات الحقن و القسطرة
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Special Education Teaching - تدريس التربية الخاصة
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Elementary Mathematics Teaching-تعليم الرياضيات
                            الابتدائي
                          </p>
                        </div>
                        <hr className="my-2" />
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Master of Medical Genetics-علم الوراثة
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Master of Nutrition and Dietetics-التغذية والانظمه
                            الغذائيه
                          </p>
                        </div>
                        <hr className="my-2" />
