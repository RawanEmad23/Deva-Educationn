        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              تأسست جامعة أتيليم في مدينة أنقرة بتاريخ 15.07.1997 من قبل وقف
              أتيليم سعيا لرفع جودة التعليم والإنتاج العلوم والتكنولوجيا ولزيادة
              البحث العلمي لتكون خلال مدة 24 عام رابع أفضل جامعة خاصة بتصنيف
              التايمز لتضم الجامعة سبعة كليات منها كلية الطب البشري وكلية
              الهندسية وثلاث معاهد فنية وثلاث معاهد لمرحلة الدراسات العليا
            </p>
            <h1 className="font-bold text-2xl text-fuchsia-950 mr-5">
              أحرمها الجامعية
            </h1>
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              يقع في منطقة كزلجاشار Kızılcaşar، أحد أحياء غول باشا في العاصمة
              التركية أنقرة، ويتميز بالآتي:
              <hr className="my-2" />
              <br className="" />
              1-المساحة الخضراء الكبيرة الممتدة إلى أكثر من 250 ألف متر مربع
              ممّا يهيئ الطلاب نفسياً للدراسة.
              <br />
              <hr className="my-2" />
              <br />
              2-يحتوي على 67 نادياً، ومجتمعاً طلابياً لتوفير جميع التسهيلات،
              وأدوات المعرفة اللازمة للطلاب.
              <br />
              <hr className="my-2" />
              3-يحتوي على عدد 5 كافتيريا كبيرة ذات جودة عالية تقوم بخدمة ما يصل
              إلى 5000 فرد.
              <hr className="my-2" />
              4-يحتوي على واحدة من أكبر، وأجمل المكتبات في أنقرة؛ وهي مكتبة
              قادرية زعيم، والتي تبلغ مساحتها ما يقارب ال 8000 متر مربع.
              <br />
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة أتيليم الإنكليزية أو التركية ويحدد ذلك
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                الهندسة.
                <br />
                إعتماد MIAK الخاص بتدريس برامج كلية العمارة والفنون الجميلة
                والتصميم.
              </p>
            </details>
            <details
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                تمتلك الجامعة سكن طلابي خاص بها ويفضل الحصول على قبول جامعي مبكر
                لتنسيق أمور السكن الجامعي وتبدأ رسوم السكن من 2000 دولار للعام
                الدراسي تتركز في منطقة Gölbaşı حرم جامعي لكل من جامعة أفق
                وأتيليم الخاصة وتتراوح رسوم السكن الجامعي بين 200 و 300 دولار
                شهريا تختلف باختلاف عدد الطلاب في الغرفة الواحدة والخدمات
                المقدمة وبعد السكن عن محطات المواصلات العامة تعد الشقق الموجودة
                في المنطقة خيار ثاني للطلاب وتعتبر رسوم الشقق في منطقة Gölbaşı
                منخفضة مقارنة ببقية مناطق إسطنبول وتتراوح بين 150 و 250 دولار
                شهريا
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                تهتم جامعة أتيليم بتكوين علاقات قوية بين الطلاب وإدارة الجامعة،
                وإجراء حوار مستمر مع الطلاب لمعرفة احتياجاتهم وتلبيتها. كما توفر
                الجامعة حياة طلابية نشطة وممتعة وتعمل على تطويرها، من خلال ما
                يلي:
                ...
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  جامعة اتيليم معتمدة من الشبكة الأوروبية لاعتماد التعليم
                  الهندسي (ENAEE)، وحصلت الجامعة على اعتماد 8 أقسام في كلية
                  الهندسة من قبل جمعية تقييم واعتماد البرامج الهندسية MUDEK.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  تتدعم الجامعة منحة الايراسموس للتبادل الطلابي مع 120 جامعة من
                  الجامعات الأوربية
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  مميزات الدراسة في جامعة أتيليم
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                تتميز جامعة أتيليم بمناهجها القوية التي تحدثها سنويًا؛ من أجل أن
                يتلقى الطالب آخر ما وصل إليه العلم في التخصص الذي يدرسه.
                <br />
                تمتلك جامعة أتيليم رابع أكبر مكتبة جامعية في مدينة أنقرة.
                <br />
                ...
                <br />
                دعم مشاريع البحث المشتركة بين معاهد الدراسات العليا بالجامعة
                والمنظمات المحلية المختلفة
                <br />
                تعليم عالي المستوى في مختلف التخصصات الأكاديمية وتقديم معظمها
                باللغة الإنجليزية
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة أتيليم
                </h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Modeling And Design Of Engineering Systems-نمذجة و
                            تصميم النظم الهندسية
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
