...
import cover from "../../Public/images/Istanbul-Kent-.jpg";
import logo from "../../Public/images/Istanbul-Kent-2 (1).jpg";
import altnnn from "../../Public/images/kent1.webp";
import altsss from "../../Public/images/kent2.webp";
import altn from "../../Public/images/kent3.webp";
import alt from "../../Public/images/kent4.webp";
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 ml-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/AVnof1AcqbE"
            allowFullScreen
          />
          ...
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              التصنيف العالمي:{" "}
              <b className="text-xl text-gray-500 max-sm:text-3xl">9626</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              التصنيف المحلي:{" "}
              <b className="text-xl text-gray-500 max-sm:text-3xl">182</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
          ...
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              عدد الطلاب :{" "}
              <b className="text-xl text-gray-500 max-sm:text-3xl">3655</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              جامعة كينت التركية (Kent Üniversitesi) هي جامعة خاصة تقع في مدينة
              إسطنبول، تركيا. تأسست عام 2016 وتُعد واحدة من الجامعات الحديثة
              التي تهدف إلى تقديم تعليم عالي الجودة في مجموعة متنوعة من
              التخصصات.
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ChatGPT جامعة كينت التركية (Kent Üniversitesi) تتميز بحرم جامعي
              حديث يقع في قلب مدينة إسطنبول، مما يوفر للطلاب بيئة تعليمية مميزة
              وموقعًا استراتيجيًا يسهل الوصول إليه. الحرم الجامعي مجهز بجميع
              المرافق التي تدعم تجربة تعليمية متكاملة، وتشمل:
              <hr className="my-2" />
              <br className="" />
              مساحات عمل مشترك لدعم المشاريع الطلابية والابتكارات.
              <br />
              <hr className="my-2" />
              <br />
              مراكز لتقديم الدعم الأكاديمي والإرشاد المهني ووحدات لتطوير
              المهارات الشخصية والمهنية.
              <br />
              <hr className="my-2" />
              مقاهي ومطاعم داخل الحرم لتلبية احتياجات الطلاب ومساحات خضراء
              ومناطق استراحة.
              <hr className="my-2" />
              مكتبة واسعة تحتوي على مجموعة كبيرة من الكتب والمراجع الأكاديمية،
              بالإضافة إلى قواعد بيانات إلكترونية.
              <br />
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة كينت الإنكليزية أو التركية ويحدد ذلك
            ...
            >
              ...
              <h1 className="font-bold text-xl text-gray-800">
                جامعة كينت التركية (Kent Üniversitesi) هي جامعة خاصة معترف بها
                ومعتمدة من قبل العديد من الهيئات الأكاديمية في تركيا. يعتمد
                اعتماد الجامعة على المعايير التي تحددها مجلس التعليم العالي
                التركي (Yükseköğretim Kurulu - YÖK)، الذي يشرف على جميع الجامعات
                في تركيا لضمان الجودة الأكاديمية.
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                <br />
                بعض البرامج الأكاديمية في جامعة كينت التركية قد تكون معتمدة من
                هيئات متخصصة في مجالات معينة مثل الطب، الهندسة، أو إدارة
                الأعمال. على سبيل المثال، قد يتم اعتماد برامج في الهندسة من قبل
                هيئة اعتماد التعليم الهندسي أو برامج في العلوم الصحية من قبل
                هيئة اعتماد التعليم الطبي في تركيا.
                <br />
                الطلاب الذين يتخرجون من جامعة كينت التركية يحصلون على شهادة
                معترف بها في تركيا، ويمكنهم العمل أو متابعة الدراسات العليا في
                العديد من البلدان.
              </p>
            </details>
            <details
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                جامعة كينت التركية (Kent Üniversitesi) تقدم لطلابها مجموعة من
                خيارات السكن الطلابي لتلبية احتياجاتهم وتوفير بيئة مريحة ومناسبة
                للدراسة. غالبًا ما يفضل الطلاب الإقامة في السكن الطلابي التابع
                للجامعة نظرًا لقربه من الحرم الجامعي والمرافق التي يوفرها
                <br />
                تقدم جامعة كينت سكنًا طلابيًا داخل الحرم الجامعي حيث يمكن للطلاب
                الإقامة في غرف فردية أو مشتركة.
                <br />
                من الأفضل للطلاب التقديم على السكن الطلابي في وقت مبكر، حيث أن
                الأماكن قد تكون محدودة في بعض الأحيان وبعض الطلاب قد يفضلون
                البحث عن سكن خارجي في حال كانوا يفضلون مزيد من الخصوصية أو إذا
                كانت خيارات السكن الجامعي مكتملة.
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الحياة الطلابية في جامعة كينت التركية (Kent Üniversitesi) مليئة
                بالأنشطة الأكاديمية والاجتماعية التي تهدف إلى تطوير مهارات
                الطلاب وخلق بيئة تعليمية شاملة. الجامعة تسعى لتقديم تجربة طلابية
                متكاملة تجمع بين الدراسة والأنشطة اللامنهجية، مما يساعد الطلاب
                على التوازن بين الدراسة وحياتهم الشخصية
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  تقدم الجامعة مجموعة من الأنشطة التي تشجع على البحث العلمي، مثل
                  ورش العمل، المؤتمرات، والمحاضرات الخاصة التي يتم تنظيمها من
                  قبل الكليات أو الفرق الأكاديمية.{" "}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  توفر الجامعة بيئة حيوية تشجع على التفاعل بين الطلاب من مختلف
                  الخلفيات الثقافية. هناك العديد من الفعاليات الاجتماعية مثل
                  الحفلات الطلابية، والمهرجانات، والأنشطة الثقافية التي تُنظم
                  طوال العام.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  تقدم الجامعة أيضًا فرصًا للتفاعل مع الأندية الطلابية، التي
                  تشمل مجموعة متنوعة من الأنشطة مثل الرياضة، الفنون، العلوم،
                  والموسيقى.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  تقدم الجامعة خدمات الدعم النفسي والإرشادي لمساعدة الطلاب في
                  التكيف مع الحياة الجامعية، وإدارة التوتر، وتحقيق التوازن بين
                  الحياة الدراسية والشخصية
                </p>
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الدراسة في جامعة كينت التركية (Kent Üniversitesi) تتمتع بعدد من
                المزايا التي تجعلها خيارًا جيدًا للطلاب المحليين والدوليين. توفر
                الجامعة بيئة تعليمية متطورة وملهمة، حيث تركز على تقديم تعليم
                أكاديمي عالي الجودة مع تقديم دعم شامل للطلاب. إليك بعض المميزات
                الرئيسية للدراسة في جامعة كينت:
                <br />
                برامج أكاديمية متنوعة: جامعة كينت تقدم برامج دراسات بكالوريوس
                ودراسات عُليا في مجموعة متنوعة من التخصصات مثل الهندسة، والعلوم
                الاجتماعية، والطب، والفنون، وإدارة الأعمال. هذه البرامج مصممة
                وفقًا للمعايير الأكاديمية العالمية.
                <br />
                تقنيات تعليمية متقدمة: توفر الجامعة بيئة تعليمية حديثة مزودة
                بأحدث التقنيات، بما في ذلك القاعات الدراسية الذكية، والمختبرات
                المتطورة، وموارد البحث الحديثة.
                <br />
                رافق متكاملة: تشمل الجامعة مكتبات، ومرافق رياضية، وقاعات دراسية
                مجهزة، ومراكز ترفيهية لدعم الطلاب في حياتهم الأكاديمية والشخصية.
                <br />
                طلاب دوليون: جامعة كينت تستقطب الطلاب من جميع أنحاء العالم، مما
                يخلق بيئة تعليمية متنوعة ثقافيًا. هذا يسمح للطلاب بالتفاعل مع
                أشخاص من خلفيات مختلفة، مما يساهم في إثراء تجربتهم التعليمية.
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة كينت
                </h2>
                  ...
                  <div className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        Information Security Technology -تكنلوجيا أمن المعلومات
                      </blockquote>
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        <div className="flex items-center gap-4">
                          <Image
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Hair Care And Beauty Services -العناية بالشعر و
                            الخدمات التجميلية
                          </p>
                        </div>
                        <hr className="my-2" />
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 text-gray-800 font-semibold text-lg">
                          المصروفات الدراسية:
                          <div className="text-gray-700 text-sm pr-1 mt-1 font-medium flex">
                            قبل الخصم :Electro Neurophysiology -الفيزيولوجيا
                            الكهربائية العصبية
                            <del className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                              3200${" "}
                            </del>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          :
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Urban Design And Landscape Architecture-التصميم
                            الحضري وعمارة المناظر
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
