...
import coveren from "../../Public/images/bah_en.png";
import coverfr from "../../Public/images/bah_fr.png";
import coverru from "../../Public/images/bach_ru.png";
import covertr from "../../Public/images/bahsh_tr.png";
import coverfa from "../../Public/images/bah_fa.jpg";
      ...
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-sm:w-[75rem] max-sm:mr-6 max-lg:w-[75rem]">
        <div className="mr-5 bg-fuchsia-900 w-[30rem] mt-5 h-14 rounded-tr-lg rounded-bl-lg">
          <h1 className="font-bold text-3xl text-yellow-500 pr-2 pl-4 py-2">
            ...
            {t("معلومات عامة عن جامعة بهشة شهير")}
          </h1>
        </div>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            {t("تقع جامعة بهتشه شهير في موقع متميز للغاية، فهي تقع في منطقة بشكتاش على حافة مضيق البوسفور بمدينة اسطنبول الجانب الأوروبي، يتميز موقع الجامعة بأنه يتواجد في منطقة حية يوجد بها كل ما يحتاجه الطالب من مواد دراسية ومناطق ترفيهية ووسائل المواصلات.")}
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("تهدف جامعة بهتشه شهير إلى أن تكون جامعة عالمية رائدة في البحث والتطوير، تركز على التميز في التعليم والمساهمة في المجتمع على المستوى المحلي والعالمي.")}
              <hr className="my-2" />
              <br className="" />
              
              {t("كما تهدف الجامعة إلى تخريج كوادر ذات كفاءة علمية ومهنية عالية تساهم في رفع المستوى المعيشي للأوطان والإنسانية، من خلال الدراسات العلمية المتفوقة، ونماذج التعليم المعاصرة التي تم تطويرها بناءً على أساليب وتقنيات التعليم الرائدة.")}
              <br />
              <hr className="my-2" />
              <br />
              
              {/* {t("جامعة بهتشه شهير كانت من أوائل الجامعات  {t("التركية")} التي قدمت محاضراتها باللغة الإنجليزية، لذلك لا تزال تمثل أولوية لدى الطلاب من حيث جودة التعليم والحصول على تعليم متكامل باللغة الإنكليزية.")} */}
              <br />
              <hr className="my-2" />
              
              {t("تهدف الجامعة إلى البحث والتطوير ونشر المعرفة والوعي بين أفراد المجتمع بهدف رفع المستوى المعيشي والعلمي للأفراد.")}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("لغات التدريس في جامعة بهتشه شهير؟")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {/* {t("اللغات المعتمدة في جامعة بهتشه شهير الإنكليزية أو  {t("التركية")} ويحدد ذلك بناءً على {t("التخصص")} المطلوب واختيار الطالب.")} */}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("جامعة بهتشه شهير (Bahçeşehir University) هي واحدة من الجامعات الخاصة الرائدة في تركيا، وتتمتع باعتمادات واعترافات دولية ومحلية تجعلها خيارًا جذابًا للطلاب من مختلف أنحاء العالم. إليك أهم المعلومات عن اعتماداتها واعترافاتها:")}
                <hr className="my-2" />
                <br />
                
                {t("مجلس التعليم العالي التركي (YÖK): جميع برامج الجامعة معتمدة من قبل YÖK، مما يعني أن شهادتها معترف بها رسميًا داخل تركيا.")}
                <br />
                
                {t("الجامعة عضو في برامج مثل Erasmus+، الذي يتيح للطلاب فرص التبادل الأكاديمي في العديد من الجامعات الأوروبية.")}
                <br />
                
                {t("برامجها معترف بها في العديد من الدول، مما يجعلها خيارًا ممتازًا للطلاب الدوليين.")}
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("السكن الأول هو سكن يونيهال Unihall")}
                <br />
                  
                   <br />
                
                {t("يمكنه استضافة حوالي 400 طالب.")}
                <br />
                
                {t("السكن الطلابي في الجامعة")}
                <br />
                
                {t("يوجد به مرافق خدمية مثل المقاهي والمطاعم والمحلات والأسواق التجارية.")}
                <br />
                
                {t("مراقب طوال اليوم عبر الكاميرات.")}
                <hr className="py-2" />
                
                {t("السكن الثاني هو سكن بيشكتاش للفتيات")}
                <br />
                
                {t("يقع بالقرب من حرم بتشكتاش.")}
                <br />
                
                {t("يتميز التصميم المعماري لهذا السكن بالأناقة والعصرية.")}
                <br />
                
                {t("يتوفر به خدمات أساسية متنوعة مثل المطاعم والكافيهات، وغرف الغسيل والتنظيف.")} 
                <br />
                
                {t("مزود بكاميرات مراقبة 24 ساعة، وأنظمة إنذار الحريق.")} 
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("تهتم جامعة بهتشه شهير بتقديم العديد من الخدمات والأنشطة الترفيهية لطلابها، حيث تحتوي الجامعة على عدٍد من الملاعب الرياضية لكرة القدم والسلة وتنس الطاولة.")}
                <br />
                
                {t("توفر الجامعة صالات الألعاب الرياضية المتنوعة")}
                <br />
                
                {t("حصلت فرق الجامعة الرياضية المختلفة على مراكز متقدمة في المسابقات الرياضية، فعلى سبيل المثال، حصل فريق كرة السلة للرجال على لقب بطل تركيا لأعوام 2007-2008-2009-2010-2011.")}
                <br />
                
                {t("تهتم الجامعة أيضًا بتنظيم العديد من المهرجانات والحفلات والرحلات البحرية، وإقامة الكثير من المؤتمرات في قاعات مجهزة لذلك.")}
                <br />
                
                {t("توفر الجامعة لطلابها تدريبات الإبحار، فهي تمتلك عدة قوارب لذاك. كما أنها تنظم كل عام بطولة تقليدية لكرة القدم يشارك في العديد من الفرق.")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("مميزات الدراسة في جامعة بهتشه شهير")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("تقدم الجامعة مناهج دراسية متطورة، تواكب التطورات العلمية العالمية ويتم تدريسها بأساليب تعليمية حديثة.")}
                <br />
                <hr className="py-2" />
                
                {t("تتميز الجامعة بطاقمها الأكاديمي والإداري المتميز الذي وصل إلى ما يقرب من 1360 أكاديمي بعضهم تم إدراجه في قائمة العلماء الأكثر تأثيراً على مستوى العالم.")}
                <br />
                <hr className="py-2" />
                
                {t("تحتوي على مكتبة بارباروس والتي تدعم برامج التعليم والبحث في الجامعة وتضمن وصول مستخدميها إلى المعلومات الصحيحة والدقيقة وفقاً للعديد من المراجع والأبحاث.")}
                <br />
                <hr className="py-2" />
                
                {t("وجود مركز تدريب BAU HUB لإنتاج وصناعة الألعاب وتطوير المشاريع الناشئة المتعلقة بالتكنولوجيا والذكاء الصناعي وتقديم محاضرات وندوات من قبل خبراء لتطوير أفكار الطلبة في ذات المجال.")}
                <br />
                <hr className="py-2" />
                
                {t("تقدم الجامعة جلسات إرشاد نفسي مجانية للطلاب والأكاديميين والموظفين في الجامعة، من خلال مركز الإرشاد والدعم النفسي في حرم الجامعة في منطقة بشيكتاش.")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("الأوراق المطلوبة للتقديم على جامعة بهتشه شهير")}
                </h2>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("كليات وتخصصات جامعة بهتشه شهير")}
                </h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                        {t("العلاج الطبيعي إعادة التأهيل")}
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                     ...
                     {t("علم الأحياء الجزيئي وعلم الوراثة")}
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          :
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                          {t("تدريس تقنيات الحاسوب والتعليم")}
 ...
 {t("تدريس اللغة الإنجليزية")}
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                          {t("التسويق الاستراتيجي و إدارة العلامات التجارية")} 
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                       ...
                       {t("ريادة الأعمال و إدارة الابتكار")}
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
               ...
               {t("الأسواق الكبرى و المالية")}
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          {t("علوم السياسة العالمية و العلاقات الدولية")}
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        {t("الدعاية و إدارة تواصل العلامات التجارية")}
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          {t("الأسواق الكبرى و قانون التجارة")}
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          {t("سلسلة التوريد والإدارة اللوجستية")}
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      {t("تحليل لبيانات الكبيرة وادارتها")} 
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
