      ...
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-sm:w-[75rem] max-sm:mr-6 max-lg:w-[75rem]">
        <div className="mr-5 bg-fuchsia-900 w-[33rem] mt-5 h-14 rounded-tr-lg rounded-bl-lg">
          <h1 className="font-bold text-3xl text-yellow-500 pr-2 pl-4 py-2">
            معلومات عامة عن جامعة إسطنبول أريل
          </h1>
        </div>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              تأسست جامعة إسطنبول أريل (Istanbul Arel University) في عام 2007 في
              مدينة إسطنبول، تركيا. تعتبر واحدة من الجامعات الخاصة المرموقة في
              البلاد، وتهدف إلى تقديم تعليم عالي الجودة يركز على الابتكار والبحث
              العلمي.
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              جامعة إسطنبول أريل (Istanbul Arel University) تمتلك حرمًا جامعيًا
              حديثًا ومجهزًا تجهيزًا جيدًا لتلبية احتياجات الطلاب الأكاديمية
              والاجتماعية. الحرم الجامعي يقع في منطقة كوتشوك شكمجه في إسطنبول،
              وهو يوفر بيئة تعليمية متكاملة. إليك بعض المعلومات عن الحرم
              الجامعي:
              <hr className="my-2" />
              <br className="" />
              مخابر متخصصة: تحتوي الجامعة على مختبرات حديثة في مجالات مثل
              الهندسة، والعلوم الصحية، والكمبيوتر، مما يوفر بيئة تعليمية عملية
              لطلابها.
              <br />
              <hr className="my-2" />
              <br />
              لفصول الدراسية الحديثة: الفصول مجهزة بأحدث التقنيات مثل الشاشات
              التفاعلية وأجهزة الكمبيوتر
              <br />
              <hr className="my-2" />
              المكتبات: تحتوي الجامعة على مكتبة واسعة تحتوي على مجموعة كبيرة من
              الكتب والمراجع الإلكترونية التي تدعم البحث والدراسة. إلى 5000 فرد.
              <hr className="my-2" />
              الحرم الجامعي يقع في منطقة قريبة من وسائل النقل العامة مثل
              الحافلات والمترو، مما يسهل الوصول إليها من مختلف مناطق إسطنبول
              <br />
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  لغات التدريس في جامعة إسطنبول أريل؟
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة إسطنبول أريل الإنكليزية أو التركية
            ...
            >
              ...
              <h1 className="font-bold text-gray-800">
                جامعة إسطنبول أريل (Istanbul Arel University) معتمدة من قبل
                العديد من الهيئات المحلية والدولية، مما يعزز من مكانتها في مجال
                التعليم العالي. إليك أبرز الاعتمادات التي تحملها الجامعة:
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                إعترف مجلس التعليم العالي التركي الـ YÖK.
                <br />
                تعتمد الجامعة على نظام الاعتماد الأكاديمي التركي (AKTS) الذي
                يساعد في ضمان جودة البرامج التعليمية والدرجات الأكاديمية التي
                تقدمها.
                <br />
                الجامعة تعتمد على معايير دولية لجودة التعليم، مثل ISO 9001، التي
                تضمن تحسين الجودة المستمر في جميع جوانب العمل الأكاديمي
                والإداري.
                <br />
                لدى الجامعة العديد من الشراكات الأكاديمية الدولية مع مؤسسات
                تعليمية في دول مختلفة، مما يساعد الطلاب في الحصول على تعليم عالي
                المستوى ومواكبة التطورات العالمية في مجالات تخصصاتهم.
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                جامعة إسطنبول أريل (Istanbul Arel University) توفر سكنًا طلابيًا
                للطلاب الذين يرغبون في الإقامة بالقرب من الحرم الجامعي. يوفر
                السكن بيئة مريحة وآمنة للطلاب من مختلف المناطق، سواء كانوا
                محليين أو دوليين
                <br />
                تميز السكن الطلابي بوجود غرف فردية أو مشتركة، حيث يمكن للطلاب
                اختيار نوع السكن الذي يناسبهم. الغرف مجهزة بالأساسيات مثل أسرة،
                خزائن، مكاتب دراسية، وأسطوانات لتخزين الأشياء.
                <br />
                يشمل السكن الطلابي خدمات أساسية مثل الإنترنت المجاني، وخدمة
                تنظيف الغرف، ومرافق للغسيل. كما يتوفر نظام تدفئة وتبريد للمساهمة
                في راحة الطلاب خلال جميع فصول السنة.
                <br />
                يحتوي السكن على مناطق مشتركة مثل غرف للأنشطة الاجتماعية، وصالات
                للاسترخاء، وغرف ترفيهية. هذه الأماكن تمنح الطلاب فرصة للتفاعل
                الاجتماعي مع زملائهم.
                <br />
                السكن الطلابي مجهز بأنظمة أمان متطورة مثل كاميرات المراقبة على
                مدار الساعة وحراس أمن لضمان سلامة الطلاب.
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الحياة الطلابية في جامعة إسطنبول أريل (Istanbul Arel University)
                تتميز بالتنوع والثراء، مما يوفر للطلاب تجربة تعليمية شاملة
                ومتوازنة بين الجوانب الأكاديمية والاجتماعية والثقافية. توفر
                الجامعة بيئة حيوية تساعد الطلاب على النمو الشخصي والمهني، وفيما
                يلي بعض جوانب الحياة الطلابية في الجامعة:
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  النوادي الطلابية: تضم الجامعة مجموعة واسعة من النوادي الطلابية
                  التي تتيح للطلاب المشاركة في الأنشطة المختلفة مثل الرياضة،
                  الفنون، التكنولوجيا، والثقافة. مثل هذه الأنشطة تساعد الطلاب
                  على تطوير مهاراتهم الشخصية والاجتماعية{" "}
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  الأنشطة الرياضية: توفر الجامعة مرافق رياضية متعددة مثل صالات
                  رياضية، ملاعب كرة القدم، كرة السلة، وغيرها من الأنشطة الرياضية
                  التي تحفز الطلاب على الحفاظ على نمط حياة صحي ونشيط.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  برنامج إيراسموس+ (Erasmus+): تشارك الجامعة في برنامج إيراسموس+
                  الذي يتيح للطلاب فرصة الدراسة في جامعات أوروبية ضمن تبادل
                  أكاديمي. كما يتمتع الطلاب الدوليون الذين يدرسون في الجامعة
                  بتجربة غنية من التفاعل الثقافي مع طلاب من مختلف أنحاء العالم
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  لإرشاد الأكاديمي: تقدم الجامعة خدمات الإرشاد الأكاديمي للطلاب
                  من خلال مستشارين أكاديميين يساعدون في تنظيم الجدول الدراسي،
                  وتقديم المشورة المهنية، وتوجيه الطلاب في مسيرتهم الأكاديمية.{" "}
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  مميزات الدراسة في جامعة إسطنبول أريل
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                دراسة في جامعة إسطنبول أريل (Istanbul Arel University) توفر
                العديد من المزايا التي تجعلها خيارًا جذابًا للطلاب المحليين
                والدوليين على حد سواء. إليك أبرز مميزات الدراسة في هذه الجامعة:
                <br />
                برامج أكاديمية متنوعة: تقدم الجامعة مجموعة واسعة من البرامج
                الدراسية في مختلف التخصصات مثل الهندسة، والعلوم الاجتماعية،
                والعلوم الصحية، والفنون، والإعلام، والإدارة. يتم تصميم البرامج
                لتلبية احتياجات السوق العالمي وتعزيز المهارات العملية.
                <br />
                التعليم المتميز: تتمتع الجامعة بمستوى أكاديمي عالٍ، حيث يدرس
                الطلاب على يد أساتذة ذوي خبرة في مجالاتهم. كما تتمتع الجامعة
                ببيئة تعليمية حديثة ومرافق متطورة تدعم التحصيل العلمي.
                <br />
                مرافق حديثة: تضم الجامعة مختبرات متطورة في مجالات الهندسة
                والعلوم، ومرافق رياضية، ومكتبات مجهزة بالكتب والمراجع الحديثة.
                كما توفر الجامعة بيئة دراسية حديثة مع الفصول الدراسية المزودة
                بأحدث التقنيات التعليمية.
                <br />
                مراكز بحثية: تقدم الجامعة بيئة مناسبة للبحث العلمي في العديد من
                المجالات من خلال مراكزها البحثية المتخصصة
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة إسطنبول أريل
                </h2>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  كليات وتخصصات جامعة إسطنبول أريل
                </h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Civil Aviation Management -إدارة الطيران المدني
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          :
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Accounting And Finance Management-إدارة المحاسبة
                            والمالية
                          </p>
                        </div>
                        <hr className="my-2" />
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Media And Cultural Studies-الإعلام و الدراسات
                            الثقافية
                          </p>
                        </div>
                        <hr className="my-2" />
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Exeutive Mba -إدارة الأعمال التنفيذية
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Urban Systems Engineering-هندسة النظم الحضرية
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Business Administration Accounting And Finance-إدارة
                            الأعمال المحاسبة و المالية
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            ...
                            Organization-إدارة الأعمال - الإدارة والتنظيم
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
