"use client"
import altnnn from "../../Public/images/koz1.webp";
import altsss from "../../Public/images/koz2.webp";
import altn from "../../Public/images/koz3.webp";
import alt from "../../Public/images/kox4.webp";
import Image from "next/image";
import cover from "../../Public/images/Beykoz-University-1.jpg";
import coveren from "../../Public/images/bekoz_en.png";
import coverfa from "../../Public/images/bekoz_fa.jpg";
import coverfr from "../../Public/images/bekoz_fr.png";
import covertr from "../../Public/images/bekoz_tr.png";
import coverru from "../../Public/images/bekoz_ru.png";
import logo from "../../Public/images/Beykoz-University.jpg";
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 my-10  -mt-0 pt-24 max-lg:w-[75rem] max-lg:mr-6">
        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50 ml-4">
          <iframe
            ...
            src="https://www.youtube.com/embed/RgHgDqPFHic"
            allowFullScreen
          />
          ...
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("التصنيف العالمي")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">8188</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("التصنيف المحلي")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">167</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">58</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              {t("عدد الطلاب")}
              <b className="text-xl text-gray-500 max-sm:text-3xl">11,800</b>
            </h1>
          </div>
          <hr />
          <div className=" flex my-5">
            ...
            <h1 className="font-bold text-gray-900 text-2xl pr-4 mt-2 max-sm:text-3xl">
              ...
              <b className="text-xl text-gray-500 max-sm:text-3xl">1648</b>
            </h1>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("تحتل جامعة بيكوز موقع استراتيجي مميز في اسطنبول، حيث تقع بمنطقة بيكوز وتطل على مضيق البوسفور الخلاب.")}
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              ...
              {t("تمتلك جامعة بيكوز 5 أحرم جامعية أشبه بتحفة معمارية وفنية، وكل حرم منهم مزود بأحدث التقنيات والمرافق والخدمات.")}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("اللغات المعتمدة في جامعة بيكوز الإنكليزية أو التركية ويحدد ذلك بناءً على التخصص المطلوب واختيار الطالب.")}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("جامعة بيكوز (Beykoz University) هي جامعة خاصة في تركيا، تأسست حديثًا نسبيًا مقارنة بالجامعات الأخرى. رغم ذلك، تسعى الجامعة لتقديم تعليم عالي الجودة معترف به محليًا ودوليًا. فيما يلي تفاصيل حول اعتمادات واعترافات جامعة بيكوز:")}
                <hr className="my-2" />
                <br />
                
                {t("جميع برامج جامعة بيكوز معتمدة من قبل مجلس التعليم العالي التركي(YÖK)، مما يعني أن شهاداتها معترف بها داخل تركيا.")}
                <br />
                
                {t("شهادة الجامعة معترف بها في العديد من الدول، خصوصًا تلك التي تربطها اتفاقيات تعليمية مع تركيا.")}
                <br />
                
                {t("الجامعة تعمل على توسيع شبكتها الدولية من خلال شراكات مع جامعات ومؤسسات أكاديمية حول العالم.")}
                <br />
                
                {t("تعتمد جامعة بيكوز على النظام الأوروبي لتحويل الساعات الدراسية (ECTS)، مما يسهل انتقال الطلاب إلى الجامعات الأوروبية ويضمن الاعتراف بالدورات والشهادات.")}
                <br />
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("الهدف الأول أن تكون الجامعة رقم واحد في جميع التخصصات العلمية.")}
                <br />
                
                {t("الإبداع في برامجها التعليمية وتطويرها وخلق روح المنافسة بين")}
              
                <br />
                
                {t("العمل على دعم البحث العلمي للطلاب الموهوبين.")}
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("تقدم جامعة بيكنت خدماتها التعليمية بأحدث الطرق والنظم التعليميةالعمل على نشر الأعمال الطلابية بشتى تخصصاتها وذلك دعما للطلاب وزيادة ثقتهم بأنفسهم.")}
                <br />
                
                {t("وهي تدعم المجال الرياضي للطلاب من خلال دعم القطاع الرياضي في الجامعة.")}
                <br />
                
                {t("احترام حقوق الإنسان وحرية الأفراد")}
                <br />
              ...
              <Image src={altn} className="mt-5 w-[40rem] mx-auto h-96" />
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
              open
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("مميزات الدراسة في جامعة بيكوز")}
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                {t("حصول جامعة بيكوز على اعتماد من قبل YÖK مجلس التعليم العالي التركي، وهو المجلس المختص باعتماد الجامعات.")}
                <br />
                <hr className="py-2" />
                
                {t("تتسم بسمعة طيبة في برامجها التعليمية.")}
                <br />
                <hr className="py-2" />
                
                {t("تعتمد الجامعة على التعليم العملي لا النظري؟ من خلال توفير تدريبات عملية في مجالات مختلفة.")}
                <br />
                <hr className="py-2" />
                
                {t("تمتلك الجامعة طاقم تدريسي ذو خبرة وكفاءة عالية.")}
                <hr className="py-2" />
                
                {t("جامعة رائدة في مجال البحث العلمي حيث تضم 4 مراكز وهم مركز تعلم اللغة التركية، مركز التعليم عن بعد، مركز التعليم مدى الحياة، مركز الأبحاث اللوجستية.")}
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  ...
                  {t("الأوراق المطلوبة للتقديم على جامعة بيكوز")}
                </h2>
