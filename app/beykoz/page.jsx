        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              تحتل جامعة بيكوز موقع استراتيجي مميز في اسطنبول، حيث تقع بمنطقة
              بيكوز وتطل على مضيق البوسفور الخلاب.
            </p>
            <h1 className="font-bold text-2xl text-fuchsia-950 mr-5">
              الحرم الجامعي{" "}
            </h1>
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              تمتلك جامعة بيكوز 5 أحرم جامعية أشبه بتحفة معمارية وفنية، وكل حرم
              منهم مزود بأحدث التقنيات والمرافق والخدمات.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة بيكوز الإنكليزية أو التركية ويحدد ذلك
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                جامعة بيكوز (Beykoz University) هي جامعة خاصة في تركيا، تأسست
                حديثًا نسبيًا مقارنة بالجامعات الأخرى. رغم ذلك، تسعى الجامعة
                لتقديم تعليم عالي الجودة معترف به محليًا ودوليًا. فيما يلي
                تفاصيل حول اعتمادات واعترافات جامعة بيكوز:
                <hr className="my-2" />
                <br />
                جميع برامج جامعة بيكوز معتمدة من قبل مجلس التعليم العالي التركي
                (YÖK)، مما يعني أن شهاداتها معترف بها داخل تركيا.
                <br />
                شهادة الجامعة معترف بها في العديد من الدول، خصوصًا تلك التي
                تربطها اتفاقيات تعليمية مع تركيا.
                <br />
                الجامعة تعمل على توسيع شبكتها الدولية من خلال شراكات مع جامعات
                ومؤسسات أكاديمية حول العالم.
                <br />
                تعتمد جامعة بيكوز على النظام الأوروبي لتحويل الساعات الدراسية
                (ECTS)، مما يسهل انتقال الطلاب إلى الجامعات الأوروبية ويضمن
                الاعتراف بالدورات والشهادات.
                <br />
                الجامعة تعمل على توسيع شبكتها الدولية من خلال شراكات مع جامعات
                ومؤسسات أكاديمية حول العالم.
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الهدف الأول أن تكون الجامعة رقم واحد في جميع التخصصات العلمية.
                <br />
                الإبداع في برامجها التعليمية وتطويرها وخلق روح المنافسة بين
                الطلاب.
                <br />
                العمل على دعم البحث العلمي للطلاب الموهوبين.
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                تقدم جامعة بيكنت خدماتها التعليمية بأحدث الطرق والنظم
                التعليميةالعمل على نشر الأعمال الطلابية بشتى تخصصاتها وذلك دعما
                للطلاب وزيادة ثقتهم بأنفسهم.
                <br />
                وهي تدعم المجال الرياضي للطلاب من خلال دعم القطاع الرياضي في
                الجامعة.
                <br />
                احترام حقوق الإنسان وحرية الأفراد
                <br />
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                حصول جامعة بيكوز على اعتماد من قبل YÖK مجلس التعليم العالي
                التركي، وهو المجلس المختص باعتماد الجامعات.
                <br />
                <hr className="py-2" />
                تتسم بسمعة طيبة في برامجها التعليمية.
                <br />
                <hr className="py-2" />
                تعتمد الجامعة على التعليم العملي لا النظري؟ من خلال توفير
                تدريبات عملية في مجالات مختلفة.
                <br />
                <hr className="py-2" />
                تمتلك الجامعة طاقم تدريسي ذو خبرة وكفاءة عالية.
                <hr className="py-2" />
                جامعة رائدة في مجال البحث العلمي حيث تضم 4 مراكز وهم مركز تعلم
                اللغة التركية، مركز التعليم عن بعد، مركز التعليم مدى الحياة،
                مركز الأبحاث اللوجستية.
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة بيكوز
                </h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Maritime And Port Management -إدارة الموانئ البحرية
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
