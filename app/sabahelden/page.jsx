        ...
        <div className="h-auto rounded-lg bg-gradient-to-r from-purple-50 to-pink-50  lg:col-span-2 max-[1366px]:grid-cols-1">
          ...
          <div className="flex text-center items-center justify-center">
            <h1 className="text-red-600 font-bold text-4xl mt-2 mb-1">
              جامعة صباح الدين زعيم في تركيا
            </h1>
          </div>
      ...
      <div className="grid bg-gradient-to-r from-violet-50 h-auto w-[96%] mr-[2%] to-fuchsia-50 rounded-lg mt-9 max-sm:w-[75rem] max-sm:mr-6 max-lg:w-[75rem]">
        <div className="mr-5 bg-fuchsia-900 w-[34rem] mt-5 h-14 rounded-tr-lg rounded-bl-lg">
          <h1 className="font-bold text-3xl text-yellow-500 pr-2 pl-4 py-2">
            معلومات عامة عن جامعة صباح الدين زعيم
          </h1>
        </div>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
          <div className=" rounded-l lg:col-span-2">
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              تأسست جامعة اسطنبول صباح الدين زعيم الوقفية على أراضي تابعة لوقف
              السلطان بيازيد الثاني من قبل وقف علم يايما عام 2010 لتحمل أسم
              البروفيسور صباح الدين زعيم والذي يعد أحد مؤسسي وقف علم يايما واحد
              قيادات التيار الإسلامي في خمسينيات القرن الماضي وتعتبر الجامعة
              جامعة وقفية بالدرجة الأولى حيث تمنح لطلابها منح تتراوح بين 25% و
              100% على الرسوم الدراسية. تضم الجامعة ثماني كليات ومعهد عالي
              لمرحلة الدراسات
            </p>
            ...
            <p className="text-gray-700 font-medium text-xl py-4 mr-5">
              جامعة صباح الدين زعيم (İstanbul Sabahattin Zaim Üniversitesi) تقع
              في مدينة إسطنبول، تركيا. الحرم الجامعي الرئيسي يتميز بطابع معماري
              عثماني فريد ومساحات خضراء واسعة. وهو يوفر بيئة تعليمية حديثة
              ومجهزة بمرافق متطورة لتلبية احتياجات الطلاب. يقع الحرم الجامعي
              الرئيسي في منطقة هالكالي بالجزء الأوروبي من إسطنبول ويوجد داخله
              مكتبة مركزية تحتوي على موارد أكاديمية رقمية ومطبوعة
              <br />
              قاعات دراسية حديثة ومجهزة\مختبرات للبحث العلمي\مساجد داخل الحرم.
        ...
        <div className="w-[80%]">
          <div className="space-y-4">
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  لغات التدريس في جامعة صباح الدين زعيم؟
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                اللغات المعتمدة في جامعة صباح الدين زعيم الإنكليزية أو التركية
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  اعترافات جامعة صباح الدين زعيم
                </h2>
              ...
              <h1 className="font-bold text-xl text-gray-800">
                جامعة صباح الدين زعيم (İstanbul Sabahattin Zaim Üniversitesi) هي
                واحدة من الجامعات التركية المعترف بها ولها اعتمادات متعددة على
                المستويين المحلي والدولي. فيما يلي أهم التفاصيل حول اعتماد
                الجامعة:
              </h1>
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                ...
                <br />
                الجامعة معترف بها في العديد من الدول العربية، مثل السعودية،
                العراق، الأردن، مصر، ودول الخليج الأخرى. هذا يجعل شهاداتها
                مقبولة للعمل والدراسات العليا في هذه الدول.
                <br />
                الجامعة عضو في برامج التبادل الطلابي الأوروبية مثل Erasmus+، مما
                يسمح لطلابها بالدراسة في جامعات أوروبية معترف بها.
              </p>
            </details>
            <details
              className="group border-s-4 border-fuchsia-800 bg-violet-100 p-6 [&_summary::-webkit-details-marker]:hidden max-lg:w-[75rem]"
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                السكن الطلابي في جامعة صباح الدين زعيم يقدم بيئة مريحة وآمنة
                للطلاب، خاصة للطلاب الدوليين، مع مراعاة توفير كافة الخدمات التي
                تساعد الطلاب على التركيز في دراستهم. فيما يلي أهم التفاصيل:
                <br />
                يوجد داخل الحرم الجامعي خيارات سكن للطلاب والطالبات. الغرف متاحة
                بأحجام مختلفة (غرف فردية، مزدوجة، ثلاثية). السكن مزود بجميع
                وسائل الراحة الأساسية مثل التدفئة، الإنترنت، والأثاث
              </p>
            ...
            >
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                الحياة الطلابية في جامعة صباح الدين زعيم غنية بالتجارب والأنشطة
                التي تعزز من تجربة الطلاب الأكاديمية والاجتماعية، وتجعلها ممتعة
                ومليئة بالتنوع الثقافي
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  <br />
                  تضم الجامعة عددًا كبيرًا من الأندية الطلابية، مثل أندية
                  الرياضة، الثقافة، التكنولوجيا، الفن، واللغات.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  تنظيم ندوات، ورش عمل، ومسابقات علمية وثقافية. رحلات داخلية
                  وخارجية لاستكشاف معالم إسطنبول وتركيا. مهرجانات طلابية
                  ومناسبات دينية وثقافية تعكس التنوع الثقافي.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  ملاعب كرة قدم، كرة سلة، تنس، وصالات رياضية مجهزة.
                </p>
                <p className="leading-relaxed  font-medium text-[18px] text-gray-700">
                  مساحات خضراء داخل الحرم ومقاهي توفر بيئة مريحة للاجتماعات
                  والدراسة.
                </p>
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  مميزات الدراسة في جامعة صباح الدين زعيم
                </h2>
              ...
              <p className="mt-4 leading-relaxed text-xl font-bold text-gray-700">
                <br />
                الجامعة تضم طلابًا من مختلف الجنسيات، مما يعزز فرص التعرف على
                ثقافات متنوعة وتكوين صداقات دولية.
                <br />
                تقدم الجامعة عددًا من المنح الدراسية للطلاب المتفوقين، بما في
                ذلك الطلاب الدوليين، مما يجعل التعليم ميسور التكلفة.
                <br />
                توفر الجامعة فرصًا للتدريب والتوظيف بالتعاون مع مؤسسات كبرى.
                <br />
                الجامعة تركز على الجمع بين القيم الأخلاقية الإسلامية والتعليم
                الحديث وتشجيع البحث والابتكار مع التمسك بالمسؤولية الاجتماعية.
              </p>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  الأوراق المطلوبة للتقديم على جامعة صباح الدين زعيم
                </h2>
            ...
            >
              <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                <h2 className="text-2xl font-bold text-fuchsia-950">
                  كليات وتخصصات جامعة صباح الدين زعيم
                </h2>
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          :
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            Information Systems Engineering - هندسة نظم
                            المعلومات
                          </p>
                        </div>
                        <hr className="my-2" />
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            European Union Studies-دراسات الاتحاد الأوروبي
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 max-sm:grid-cols-2">
                      ...
                      <blockquote className="rounded-lg bg-gray-50 p-6 shadow-sm sm:p-8">
                        ...
                        <div className="mt-4 flex">
                          ...
                          <p className="text-gray-600 text-sm pr-1 mt-1 font-medium">
                            political Economics-الاقتصاد السياسي
                          </p>
                        </div>
                        <hr className="my-2" />
                        <div className="mt-4 flex">
